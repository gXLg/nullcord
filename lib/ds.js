...
class Bot {
  ...
  async login(intents){
    ...
    async function connect(bot, resume, shard){
      ...
      bot.logger.emit("swarn", "Debug: connect(bot,", resume + ",", shard + ")");
      ...
      bot.logger.emit("swarn", "Debug: get gateway = ", gateway);
      ...
      bot.logger.emit("swarn", "Debug: creating WebSocket...");
      ...
      bot.logger.emit("swarn", "Debug: ws done");

      ws.on("message", data => {

        bot.logger.emit("swarn", "Debug: ws event:", data);
