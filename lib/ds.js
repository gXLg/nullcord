...
class Bot {
  ...
  async login(intents) {
    ...
    async function handleShards() {
      ...
      const shards = gateway.internal_shards;
    ...
    await handleShards();
    this.internal_shardsInterval = setInterval(handleShards, 60 * 60 * 1000);
  }
  ...
  async shutdown(restart) {
    ...
    if (!restart) {
      ...
      clearInterval(this.internal_shardsInterval);
    }
  ...
  self = {
    ...
    "listGuilds": async (sopt = { }) => {
      ...
      if (sopt.limit != null != null) p.set("limit", sopt.limit);
      if (sopt.before != null) p.set("before", sopt.before);
      if (sopt.after != null) p.set("after", sopt.after);
    ...
    "listJoinedPrivateArchivedThreads": async (channelId, sopt = { }) => {
      const p = new URLSearchParams();
      if (sopt.limit != null) p.set("limit", sopt.limit);
      if (sopt.before != null) p.set("before", sopt.after);
      const r = (p.size ? "?" : "") + p.toString();
      return this.rest.get(
  ...
  messages = {
    ...
    "list": async (channelId, sopt = { }) => {
      ...
      if (sopt.before != null) p.set("before", sopt.before);
      if (sopt.after != null) p.set("after", sopt.after);
      if (sopt.around != null) p.set("around", sopt.around);
      const r = (p.size ? "?" : "") + p.toString();
      return this.rest.get(
  ...
  threadMembers = {
    ...
    "get": async (channelId, userId, sopt = { }) => {
      const p = new URLSearchParams();
      if (sopt.with_member != null) p.set("with_member", with_member);
      const r = (p.size ? "?" : "") + p.toString();
      return this.rest.put(
    ...
    "list": async (channelId, sopt = { }) => {
      const p = new URLSearchParams();
      if (sopt.with_member != null) p.set("with_member", sopt.with_member);
      if (sopt.limit != null) p.set("limit", sopt.limit);
      if (sopt.after != null) p.set("after", sopt.after);
      const r = (p.size ? "?" : "") + p.toString();
      return this.rest.get(
  ...
  members = {
    ...
    "search": async (guildId, sopt = { }) => {
      const p = new URLSearchParams();
      if (sopt.limit != null) p.set("limit", sopt.limit);
      if (sopt.search != null) p.set("query", sopt.search);
      const r = (p.size ? "?" : "") + p.toString();
      return this.rest.get(
  ...
  prunes = {
    "get": async (guildIs, sopt = { }) => {
      const p = new URLSearchParams();
      if (sopt.days != null) p.set("days", sopt.days);
      if (sopt.includes_roles != null) p.set("includes_roles", sopt.includes_roles.join(","));
      const r = (p.size ? "?" : "") + p.toString();
      return this.rest.get(
  ...
  guilds = {
    ...
    "get": async (guildId, sopt = { }) => {
      const p = new URLSearchParams();
      if (sopt.with_counts != null) p.set("with_counts", sopt.with_counts);
      const r = (p.size ? "?" : "") + p.toString();
      return this.rest.get(
        "/guilds/" + guildId + r,
        "/guilds/" + guildId
