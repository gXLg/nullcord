...
class Bot {
  ...
  me = {
    ...
    "listPrivateJoinedArchivedThreads": async (channelId, sopt = { }) => {
      const p = new URLSearchParams();
  ...
  threadMembers = {
    ...
    "list": async (channelId, sopt = { }) => {
      const p = new URLSearchParams();
      if(sopt.member != null) p.set("with_member", sopt.member);
      if(sopt.limit != null) p.set("limit", sopt.limit);
      if(sopt.after != null) p.set("after", sopt.after);
      const r = (p.size ? "?" : "") + p.toString();
      return this.rest.get(
  ...
  prunes = {
    "get": async (guildIs, sopt = { }) => {
      ...
      if(sopt.roles != null) p.set("includes_roles", sopt.roles.join(","));
      const r = (p.size ? "?" : "") + p.toString();
      return this.rest.get(
  ...
  guilds = {
    ...
    "get": async (guildId, sopt = { }) => {
      const p = new URLSearchParams();
      if(sopt.counts != null) p.set("with_counts", sopt.counts);
      const r = (p.size ? "?" : "") + p.toString();
      return this.rest.get(
        "/guilds/" + guildId + r,
        "/guilds/" + guildId
